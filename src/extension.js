...
import { toggleDiffMode } from './commands/DiffToggle.js'; // ADDED THIS LINE
/**
...
export async function activate(context)
{
  ...
  const cmdToggleDiff = vscode.commands.registerCommand('perforce.toggleDiffMode', toggleDiffMode); // ADDED THIS LINE
  await configService.ensureOpenAIConfig();
